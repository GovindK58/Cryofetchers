...
O3_CPU::O3_CPU(uint32_t cpu, double freq_scale, std::size_t dib_set, std::size_t dib_way, std::size_t dib_window, std::size_t ifetch_buffer_size,
        ...
        bpred_type(bpred_type), btb_type(btb_type), ipref_type(ipref_type)
  {
    ...
    CACHE* l1i_lvl = (CACHE*)l1i;
    CACHE* l1d_lvl = (CACHE*)l1d;
    CACHE* l2_lvl = (CACHE*)(l1i_lvl->lower_level);
    CACHE* llc_lvl = (CACHE*)(l2_lvl->lower_level);

    llc_lvl->higher_level = l2_lvl;
    l2_lvl->higher_level = l1d_lvl;
    l1d_lvl->higher_level = nullptr;
    l1i_lvl->higher_level = nullptr;
  }
